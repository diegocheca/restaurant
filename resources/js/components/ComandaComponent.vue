	...
	<div class="container">
		...
		<div class="tab-content" id="pills-tabContent">
			...
			<div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
				<ticket-cancelados></ticket-cancelados>
			</div>
		</div>
		<button @click="mostrar('algo123')">toastr</button>
		{{since('2020-03-16 11:38:35')}}
	</div>
</template>

<script>

	//import sinhacer from 'ticket-row'
	import moment from 'moment'
	import toastr from 'toastr'

	//@import "~toastr/build/toastr.css";

	Vue.component('ticket-row', require('./TicketRowComponent.vue'));
	Vue.component('ticket-yahechos', require('./TicketYaHechosComponent.vue'));
	Vue.component('ticket-cancelados', require('./TicketCanceladosComponent.vue'));

	//Vue.component('ticket-cancelados', require('./TicketCanceladosComponent.vue'));
	//Vue.component('ticketsinhacer', sinhacer)
